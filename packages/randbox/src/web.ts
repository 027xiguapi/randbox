 ...
 * @param options.tld - Top-level domain to use
 ...
 * @param options - Configuration options
 * @param options.domain - Domain to use for the email
 * @param options.length - Length of the email username
 ...
 * @returns Random hashtag with # prefix
 */
...
/**
 * Generate a random Klout score
 * @returns Random Klout score (1-99)
 */
 ...
 * @param options - Configuration options
 * @param options.str - String to hash (or random if not provided)
 * @param options.key - HMAC key
 * @param options.raw - Return raw binary instead of hex
 * @returns Random or computed MD5 hash
 */
 ...
 * @returns Random port number (0-65535)
 */
...
/**
 * Generate a random Twitter handle
 * @returns Random Twitter handle with @ prefix
 */
 ...
 * @param options - Configuration options
 * @param options.protocol - URL protocol (default: 'http')
 * @param options.domain - Domain name
 * @param options.domain_prefix - Domain prefix
 * @param options.path - URL path
 * @param options.extensions - File extensions array
 * @returns Random URL
 */
 ...
 * @param options - Configuration options
 * @param options.width - Image width (default: 500)
 * @param options.height - Image height (default: 500)
 * @param options.greyscale - Generate greyscale image
 * @param options.blurred - Generate blurred image
 * @returns Random Lorem Picsum URL
 */
 ...
 * @param options - Configuration options
 * @param options.region - Return regions instead of languages
