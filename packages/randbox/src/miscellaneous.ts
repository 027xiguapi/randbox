...
/**
 * Generate a dice function for a specific range
 * @param range - Dice range configuration
 * @returns Function that rolls dice
 */
...
/**
 * Generate a random TV call sign (alias for radio)
 * @param options - Configuration options
 * @returns Random TV call sign
 */
...
/**
 * Roll RPG dice using standard notation (e.g., '3d6', '1d20')
 * @param thrown - Dice notation string (e.g., '3d6')
 * @param options - Configuration options
 * @param options.sum - Return sum instead of array
 * @returns Array of dice rolls or sum
 */
 ...
 * @param options - Configuration options
 * @param options.version - GUID version (default: 5)
 ...
 * @param options - Configuration options
 * @param options.length - Hash length (default: 40)
 * @param options.casing - Text casing ('upper' or 'lower')
...
/**
 * Generate random AM/PM designation
 * @returns 'am' or 'pm'
 */
 ...
 * @param options - Configuration options
 * @param options.min - Minimum date
 * @param options.max - Maximum date
 * @param options.american - Use American date format
 * @param options.string - Return as string instead of Date object
 * @param options.year - Specific year
 * @param options.month - Specific month
 * @param options.day - Specific day
 * @returns Random date
 */
...
/**
 * Generate a random timestamp (alias for date().getTime())
 * @param options - Configuration options (same as date)
 ...
 * @returns Random millisecond (0-999)
 */
 ...
 * @param options - Configuration options
 * @param options.min - Minimum second (default: 0)
 * @param options.max - Maximum second (default: 59)
 ...
 * @param options - Configuration options
 * @param options.min - Minimum minute (default: 0)
 * @param options.max - Maximum minute (default: 59)
 ...
 * @param options - Configuration options
 * @param options.min - Minimum hour
 * @param options.max - Maximum hour
 * @param options.twentyfour - Use 24-hour format
 * @returns Random hour
 */
 ...
 * @param options - Configuration options
 * @param options.min - Minimum month (1-12)
 * @param options.max - Maximum month (1-12)
 * @param options.raw - Return month object instead of name
 * @returns Random month name or object
 */
 ...
 * @returns Random Unix timestamp in seconds
 */
 ...
 * @param options - Configuration options
 * @param options.weekday_only - Exclude weekends
 * @returns Random weekday name
 */
 ...
 * @param options - Configuration options
 * @param options.min - Minimum year
 * @param options.max - Maximum year
 * @returns Random year as string
 */
 ...
 * @returns Random timezone string
 */
 ...
 * @param options.networkVersion - Use network version format
