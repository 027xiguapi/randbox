...
/**
 * Generate a random Italian VAT number
 * @returns Random Italian VAT number
 */
 ...
 * @param options.gender - Gender ('male' or 'female')
 * @param options.birthday - Birth date
 * @param options.city - City code
 * @returns Random Italian fiscal code
 */
...
/**
 * Generate a random Polish PESEL (Personal Identity Number)
 * @returns Random Polish PESEL number
 */
...
/**
 * Generate a random Polish NIP (Tax Identification Number)
 * @returns Random Polish NIP number
 */
...
/**
 * Generate a random Polish REGON (Business Registry Number)
 * @returns Random Polish REGON number
 */
...
/**
 * Generate a random VAT number for specified country
 * @param options - Configuration options
