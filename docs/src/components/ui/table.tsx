...
const TableHeader = ({ ref, className, ...props }: React.HTMLAttributes<HTMLTableSectionElement> & { ref?: React.RefObject<HTMLTableSectionElement | null> }) => <thead ref={ref} className={cn('[&_tr]:border-b', className)} {...props} />
