---
title: "set"
description: "RandBox page: set, includes examples and docs."
date: "2025-10-16"
tags: ["RandBox", "helpers", "set"]
keywords: ["RandBox", "helpers", "set", "random", "JavaScript", "MDX"]
---
...
Used for overriding the default data used by randBox.
