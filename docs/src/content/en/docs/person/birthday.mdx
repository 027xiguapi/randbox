---
title: "birthday"
description: "RandBox page: birthday, includes examples and docs."
date: "2025-10-16"
tags: ["RandBox", "person", "birthday"]
keywords: ["RandBox", "person", "birthday", "random", "JavaScript", "MDX"]
---
...
You can compose with `randBox.year` for interesting combinations. For example, let's say we want to get the birthdays of some renaissance artists (born between 1450 and 1500). We can generate a year and then get a birthday from that year:
